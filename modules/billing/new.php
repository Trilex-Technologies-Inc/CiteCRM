...
/* check if invoice is already paid or there is at least an amout to bill */
$q = "SELECT count(*) as count, INVOICE_AMOUNT, INVOICE_DATE, INVOICE_DUE,INVOICE_ID, BALLANCE, WORKORDER_ID  FROM ".PRFX."TABLE_INVOICE WHERE INVOICE_PAID='0' AND INVOICE_ID=".$db->qstr($invoice_id)." GROUP BY INVOICE_ID";

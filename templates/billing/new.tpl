				...
				<td class="olotd5" colspan="2">
					...
					<table width="100%" cellpadding="4" cellspacing="0" border="0" class="olotable">
						...
						{foreach item=item from=$invoice_details}
							...
							<td>
								{if $item.BALLANCE > 0}
									<font color="#CC0000">{$item.BALLANCE|string_format:"%.2f"}</font>
								{else}
									...
									<td class="menutd2">
										<table width="100%" cellpadding="4" cellspacing="0" border="0" width="100%" class="olotable">
											<tr class="olotd4">
												...
												<td>$<input type="text" name="cc_amount" {if $ballance > 0} value="{$ballance}" {else} value="{$invoice_amount|string_format:"%.2f"}" {/if} size="6">
							...
							<td class="menuhead2">&nbsp;{$translate_billing_check}</td>
									...
									<td class="menutd2">
										<table width="100%" cellpadding="4" cellspacing="0" border="0" width="100%" cellpadding="4" cellspacing="0" border="0" class="olotable">
											<tr class="olotd4">
												<td class="row2"></td>
												<td class="row2"><b>{$translate_billing_check_no}</b></td>
												<td class="row2"><b>{$translate_billing_amount}</td>	
											</tr><tr class="olotd4">
												<td></td>
												<td><input type="text" name="check_recieved" size="8" class="olotd4"></td>
												<td>$<input type="text" name="check_amount" size="8" {if $ballance > 0} value="{$ballance|string_format:"%.2f"}" {else} value="{$invoice_amount|string_format:"%.2f"}" {/if} class="olotd4"></td>
											</tr><tr>
												<td valign="top"><b>{$translate_billing_memo}</b></td>
												<td colspan="2"><textarea name="check_memo" class="olotd4"></textarea></td>
											</tr>
										</table>
										<p>
											<input type="hidden" name="customer_id"  value="{$customer_id}">
											...
											<input type="submit" name="submit" value="Submit Check Payment">
										</p>
									</td>
								</tr>
							</td>
									...
									<td class="menutd2">
										<table width="100%" cellpadding="4" cellspacing="0" border="0" width="100%"  class="olotable">
											<tr class="olotd4">
												...
												<td></td>
												<td>
													$<input type="text" name="cash_amount" size="8" {if $ballance > 0} value="{$ballance|string_format:"%.2f"}" {else} value="{$invoice_amount|string_format:"%.2f"}" {/if} class="olotd4">
												</td>
											</tr><tr>
												<td valign="top"><b>{$translate_billing_memo}</b></td>
									...
									<td class="menutd2">
										<table width="100%" cellpadding="4" cellspacing="0" border="0" class="olotable">
											<tr class="olotd4">
												...
												<td></td>
												<td><input type="text" name="gift_amount" size="8" {if $ballance > 0} value="{$ballance|string_format:"%.2f"}" {else} value="{$invoice_amount|string_format:"%.2f"}" {/if} class="olotd4"></td>
									...
									<td class="menutd2">
										<table width="100%" cellpadding="4" cellspacing="0" border="0" width="100%" cellpadding="4" cellspacing="0" border="0" class="olotable">
											<tr class="olotd4">
												...
												<td></td>
												<td><input type="text" name="paypal_amount" size="8" value="{$invoice_amount}" class="olotd4"></td>
												<td></td>
											</tr>
										</table>
										<p>

<div class="container my-4">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            function validate_edit_subcat(frm) {
                var value = '';
            ...
            <form action="?page=cats:subcat_edit&id={$subcat_details.ID}"
                  method="POST"
                  name="edit_subcat"
                  id="edit_subcat"
                  onsubmit="return validate_edit_subcat(this);">
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="sub_category"
                               value="{$subcat_details.SUB_CATEGORY}"
                               class="form-control">
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="description" 
                                  rows="5" 
                                  class="form-control">{$subcat_details.DESCRIPTION}</textarea>
                    </div>
                </div>

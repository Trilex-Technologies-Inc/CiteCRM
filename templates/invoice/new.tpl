							...
							<tr>
								...
								<table width="100%" cellpadding="4" cellspacing="0" border="0" class="olotable">
									<tr class="olotd4">
										...
										<td class="row2"><b>{$translate_invoice_date}</td>
										<td class="row2"><b>{$translate_invoice_due}</td>
										...
										<td>
											<input size="10" name="date" type="text" id="date" value="{$invoice.INVOICE_DATE|date_format:"%m/%d/%y"}" class="olotd4"/>
										...
										<td>{$item.INVOICE_DUE}
											<input size="10" name="due_date" type="text" id="due_date" value="{$invoice.INVOICE_DUE|date_format:"%m/%d/%y"}" class="olotd4"/>
										...
										{foreach item=item from=$customer_details}
											<table cellpadding="0" cellspacing="0">
												<tr>
													...
													<input type="text" class="olotd4" size="6" name="discount" value="{$item.DISCOUNT}">%
												</td>
												</tr>
											</table>
											{/foreach}		
								...
								{if $invoice.INVOICE_AMOUNT > 0 }
									<p>
										<a href="?page=invoice:print&wo_id={$invoice.WORKORDER_ID}&customer_id={$invoice.CUSTOMER_ID}&invoice_id={$invoice.INVOICE_ID}&escape=1" target="new">{$translate_invoice_print}</a>
									
									{if $wo_status == '9'}
										&nbsp;<a href="?page=billing:new&wo_id={$invoice.WORKORDER_ID}&customer_id={$invoice.CUSTOMER_ID}&invoice_id={$invoice.INVOICE_ID}&page_title=Billing">{$translate_invoice_bill_customer}</a>
									{else}

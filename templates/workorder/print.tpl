...
<table  width="900" border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse;">
	<tr>
		...
		<!-- right column -->
		<td valign="top" width="20%"><br><br><center><b><font color=5174F6><center>Powered</font><font color=FF550B>By</font><font color=5174F6>CiteCRM</font><br><font color=FF550B>www.citecrm.com</font></center></b></td>
	</tr><tr>
		<!-- left Column -->
		...
		<td valign="top" width="20%">
			...
			<table width="100%" cellpadding="4" cellspacing="0" border="0">
				<tr>
					...
					<b>Type:</b> {$single_workorder_array[i].CUSTOMER_TYPE}</td>
				</tr>
			</table>
			<!--OLD LINE-->
			<hr>
				...
				<tr>
					...
					<td>
						{section name=e loop=$work_order_sched}
							<b>Start</b> {$work_order_sched[e].SCHEDUAL_START|date_format:"%m-%d-%Y %I:%M  %p"}<br>
							<b>End</b> {$work_order_sched[e].SCHEDUAL_END|date_format:"%m-%d-%Y %I:%M  %p "} <br>
...
Primary:</b>&nbsp {$company[d].COMPANY_TOLL_FREE}<br>
						    <b>Secondary:</b>&nbsp {$company[d].COMPNAY_PHONE}<br>
		...
		<td valign="top" width="60%">
			<table border="0" cellpadding="4" cellspacing="0">
				<tr>
					...
					<b>Enter By: </b>{$work_order_notes[b].EMPLOYEE_DISPLAY_NAME}  
							<br><b>Date: </b> {$work_order_notes[b].WORK_ORDER_NOTES_DATE|date_format:"%m-%d-%Y"}<br>
							</p>
						{/section}
					</td>
				</tr>
				...
				<tr>
					...
					{section name=r loop=$work_order_res}
						{if $work_order_res[r].EMPLOYEE_DISPLAY_NAME != ''}
							<b>Closed By:</b> {$work_order_res[r].EMPLOYEE_DISPLAY_NAME} <b>Date:</b>  {$work_order_res[r].WORK_ORDER_CLOSE_DATE|date_format:"%m-%d-%Y"}
		...
		<td valign="top" width="20%">
			<table border="0" cellpadding="4" cellspacing="0">
				<tr>
					...
					<td valign="top">{$single_workorder_array[i].WORK_ORDER_OPEN_DATE|date_format:"%m-%d-%y"}</td>
				</tr><tr>
					<td valign="top"><b>Status:</b></td>
					<td valign="top">{if $single_workorder_array[i].WORK_ORDER_CURENT_STATUS == "1"}
							Created

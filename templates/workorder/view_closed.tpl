	...
	<tr>
		<td>
			<table width="700" cellpadding="4" cellspacing="0" border="0" >
				<tr>
					<td class="menuhead2" width="80%">&nbsp;{$translate_workorder_view_closed}</td>
					<td class="menuhead2" width="20%" align="right" valign="middle">
						<a href="http://www.citecrm.com/docs/#work_orders" target="new"><img src="images/icons/16x16/help.gif" border="0"></a>
					</td>
					</tr><tr>
									...
									<!-- Content -->
										<table class="menutable" width="100%" border="0" cellpadding="5" cellspacing="0">
											<tr>
												...
												<form id="1">
													<a href="?page=workorder:view_closed&submit=submit&page_no=1"><img src="images/rewnd_24.gif" border="0"></a>&nbsp;
													{if $previous != ''}
														<a href="?page=workorder:view_closed&submit=submit&page_no={$previous}"><img src="images/back_24.gif" border="0"></a>&nbsp;
													{/if}
													...
													{if $next != ''}
													<a href="?page=workorder:view_closed&submit=submit&page_no={$next}"><img src="images/forwd_24.gif" border="0"></a>
													{/if}
													
													<a href="?page=workorder:view_closed&submit=submit&page_no={$total_pages}"><img src="images/fastf_24.gif" border="0"></a>
													<br>
													{$total_results} {$translate_workorder_records}
													</form>
												</td>
											</tr><tr>
												<td valign="top" colspan="2">
													<table class="olotable" width="100%" border="0" cellpadding="4" cellspacing="0">
														...
														<tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='?page=workorder:view&wo_id={$work_order.WORK_ORDER_ID}&customer_id={$work_order.CUSTOMER_ID}&page_title={$translate_workorder_page_title} {$work_order.WORK_ORDER_ID}';" class="row1">
															...
															<td class="olotd4"> {$work_order.WORK_ORDER_OPEN_DATE|date_format:"%m-%d-%Y"}</td>
															<td class="olotd4">{$work_order.WORK_ORDER_CLOSE_DATE|date_format:"%m/%d/%Y"}</td>
														
															<td class="olotd4" nowrap>
																<img src="images/icons/16x16/view+.gif" border="0" onMouseOver="ddrivetip('<b><center>Contact Info</b></center><hr><b>Phone: </b>{$work_order.CUSTOMER_PHONE}<br> <b>Work: </b>{$work_order.CUSTOMER_WORK_PHONE}<br><b>Moile: </b>{$work_order.CUSTOMER_MOBILE_PHONE}<br><br>{$work_order.CUSTOMER_ADDRESS}<br>{$work_order.CUSTOMER_CITY}, {$work_order.CUSTOMER_STATE}<br>{$work_order.CUSTOMER_ZIP}')" onMouseOut="hideddrivetip()">
															...
															<td class="olotd4" nowrap>
																<img src="images/icons/16x16/view+.gif" border="0" onMouseOver="ddrivetip('<center><b>Contact</b></center><hr><b>Work: </b>{$work_order.EMPLOYEE_WORK_PHONE}<br><b>Mobile: </b>{$work_order.EMPLOYEE_MOBILE_PHONE}<br><b>Home: </b>{$work_order.EMPLOYEE_HOME_PHONE}')" onMouseOut="hideddrivetip()"> 

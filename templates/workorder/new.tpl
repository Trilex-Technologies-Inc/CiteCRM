		...
		<td><!-- Begin Page -->
			<table width="700" cellpadding="5" cellspacing="0" border="0" >
				<tr>
					...
					<td class="menuhead2" size="10%" align="right"><a href="http://www.citecrm.com/docs/#work_orders" target="new"><img src="images/icons/16x16/help.gif" border="0"></a>
				</tr><tr>
					...
					<table width="100%" class="olotable" cellpadding="5" cellspacing="0" border="0" >
												...
												<tr>
													...
													<td class="menuhead2" width="20%" align="right">
														<a href="?page=customer:edit&customer_id={$customer_details[i].CUSTOMER_ID}">
															<img src="images/icons/16x16/small_edit.gif" border="0"
						...
						<table class="olotable" width="100%" border="0" summary="Work order display">
							<tr>
								...
								<td class="olotd"><textarea  class="olotd4" rows="15" cols="70" mce_editable="true" name="work_order_discription"></textarea></td>
							</tr>
						</table>
						<br>
						<table class="olotable" width="100%" border="0" summary="Work order display">
							<tr>
								...
								<td class="olotd"><textarea class="olotd4" rows="15" cols="70" mce_editable="true" name="work_order_comments"></textarea></td>
							</tr>
						</table>	
						<br>
						<!-- Work Order Notes -->

...
function create_table_invoice($db)
{
  ...
  `BALLANCE` decimal(10,2) NOT NULL default '0.00',
...
function create_table_invoice_parts($db)
{
  ...
  `INVOICE_PARTS_SUBTOTA` decimal(10,2) NOT NULL default '0.00',
  `SHIPPING` decimal(10,2) NOT NULL default '0.00',
...
function create_table_transactions($db)
{
  ...
  `INVOCIE_ID` int(11) NOT NULL default '0',
  `WORKORDER_ID` int(11) NOT NULL default '0',
  `CUSTOMER_ID` int(11) NOT NULL default '0',
  `MEMO` text NOT NULL,
  `AMOUNT` decimal(10,2) NOT NULL default '0.00',
  PRIMARY KEY  (`TRANSACTION_ID`),
  KEY `INVOCIE_ID` (`INVOCIE_ID`,`WORKORDER_ID`,`CUSTOMER_ID`),
  KEY `DATE` (`DATE`),
  KEY `TYPE` (`TYPE`),
...
function create_table_workorder($db)
{
  ...
  `WORK_ORDER_CURENT_STATUS` int(2) NOT NULL default '0',
...
(4, 'customer:edit', 1, 1, 1, 1),
(5, 'customer:new', 1, 1, 1, 1),
(6, 'core:error', 1, 1, 1, 1),
(7, 'workorder:main', 1, 1, 1, 1),
(8, 'workorder:new', 1, 1, 1, 1),
(9, 'workorder:view', 1, 1, 1, 1),
(10, 'workorder:new_note', 1, 1, 1, 1),
(11, 'workorder:close', 1, 1, 1, 1),
(12, 'workorder:print', 1, 1, 1, 1),
(13, 'workorder:new_status', 1, 1, 1, 1),
(14, 'schedual:main', 1, 1, 1, 1),
(15, 'schedual:new', 1, 1, 1, 1),
(16, 'invoice:new', 1, 1, 1, 1),
(17, 'employees:main', 1, 1, 1, 1),
(18, 'employees:employee_details', 1, 1, 1, 1),
(19, 'employees:edit', 0, 0, 0, 1),
(21, 'billing:new', 1, 1, 1, 1),
(22, 'billing:proc_cash', 1, 1, 1, 1),
(23, 'proc_check', 1, 1, 1, 1),
(24, 'billing:proc_cc', 1, 1, 1, 1),
(25, 'invoice:view', 1, 1, 1, 1),
(26, 'invoice:print', 1, 1, 1, 1),
(27, 'control:main', 0, 0, 0, 1),
(28, 'control:company_edit', 0, 0, 0, 1),
(29, 'control:hours_edit', 0, 0, 0, 1),
(30, 'employees:new', 0, 0, 0, 1),
(31, 'stats:hit_stats', 0, 0, 0, 1),
(32, 'stats:main', 1, 1, 0, 1),
(33, 'control:payment_options', 0, 0, 0, 1),
(34, 'stats:hit_stats_view', 0, 0, 0, 1),
(35, 'billing:proc_check', 1, 1, 1, 1),
(36, 'invoice:view_paid', 1, 1, 1, 1),
(37, 'invoice:view_unpaid', 1, 1, 1, 1),
(38, 'workorder:view_closed', 1, 1, 1, 1),
(39, 'control:acl', 0, 0, 0, 1),
(40, 'control:import_parts', 0, 0, 0, 1),
(41, 'parts:main', 1, 1, 1, 1),
(42, 'parts:checkout', 1, 1, 1, 1),
(43, '', 1, 1, 1, 1),
(44, 'schedual:view', 1, 1, 1, 1),
(45, 'schedual:print', 1, 1, 1, 1),
(46, 'schedual:edit ', 1, 1, 1, 1),
(47, 'schedual:delete', 1, 1, 1, 1),
(48, 'customer:delete', 1, 0, 0, 1),
(49, 'control:edit_rate', 0, 0, 0, 1),
(50, 'billing:proc_paypal', 1, 1, 1, 1),
(51, 'billing:pp_complete', 1, 1, 1, 1),
(52, 'parts:status', 1, 1, 1, 1),
(53, 'parts:view', 1, 1, 1, 1),
(54, 'parts:update', 1, 1, 1, 1),
(55, 'billing:new_gift', 1, 1, 1, 1),
(56, 'billing:proc_gift', 1, 1, 1, 1),
(57, 'workorder:edit_description', 1, 1, 1, 1),
...
{
	// Intentionally do not seed subcategories during install.
	return true;
}

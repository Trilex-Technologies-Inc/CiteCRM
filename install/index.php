        ...
        <body class="bg-light">
            ...
            <footer class="mt-5 py-4 bg-dark text-white">
                <div class="container text-center">
                    <p class="mb-0">Copyright 2005 - <?php echo date('Y'); ?> &copy; In-Cite CRM <a href="http://www.incitecrm.com" class="text-white" target="_blank">www.incitecrm.com</a> All rights reserved.</p>
                </div>
            </footer>

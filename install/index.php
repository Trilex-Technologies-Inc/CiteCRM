...
<head>
    ...
    <style>
        .install-header { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 2rem 0; }
        .step-indicator { border-left: 4px solid #28a745; padding-left: 1rem; margin: 1rem 0; }
        .success-badge { background-color: #28a745; color: white; padding: 0.25rem 0.75rem; border-radius: 20px; font-size: 0.875rem; }
        .warning-badge { background-color: #ffc107; color: #000; padding: 0.25rem 0.75rem; border-radius: 20px; font-size: 0.875rem; }
        .danger-badge { background-color: #dc3545; color: white; padding: 0.25rem 0.75rem; border-radius: 20px; font-size: 0.875rem; }
    </style>
</head>
<body class="bg-light">
    <!-- Header -->
                            ...
                            if(isset($error_flag) and $error_flag == true) {
                                ...
                                <div class="card mt-4">
                                    <div class="card-body">
                                        ...
                                        <strong>Password:</strong> [The password you supplied]</p>
...
<head>
    ...
    <style>
        .install-header { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 2rem 0; }
        .section-title { border-left: 4px solid #667eea; padding-left: 1rem; margin: 1.5rem 0 1rem 0; }
        ...
        .file-check-item { display: flex; justify-content: space-between; align-items: center; padding: 0.5rem; border-bottom: 1px solid #dee2e6; }
        .file-check-item:last-child { border-bottom: none; }
    </style>
</head>
<body class="bg-light">
    <!-- Header -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="password" class="form-control" name="default_password" required>
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label class="form-label required-field">Confirm Password</label>
                                                <input type="password" class="form-control" name="default_password2" required>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label required-field">Zip</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" name="default_email" required>
                                            </div>
...
function validate($data) {
    foreach($data as $key => $val) {
        if($val == "") {
            error_check("Missing field $key.");
        }
    }
    
    if($data['default_password'] != $data['default_password2']) {
        error_check("Administrators Passwords do not match.");	
    }
}
?>